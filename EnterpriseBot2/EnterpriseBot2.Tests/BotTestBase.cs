...
using Autofac;
using EnterpriseBot2;
using EnterpriseBot2.Dialogs.Onboarding;
using EnterpriseBot2.Middleware.Telemetry;
using EnterpriseBot2.Tests.LuisTestUtils;
using EnterpriseBot2.Tests.LUTestUtils;
using Microsoft.Bot.Builder;
using Microsoft.Bot.Builder.Adapters;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace EnterpriseBot2.Tests
{
    public class BotTestBase
    {
        ...
        {
            return new EnterpriseBot2.Bot(BotServices, ConversationState, UserState, TelemetryClient);
        }
    }
}
