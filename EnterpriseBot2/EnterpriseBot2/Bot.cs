...
using EnterpriseBot2.Dialogs.Main;

namespace EnterpriseBot2
{
    /// <summary>
    ...
    public class Bot : IBot
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseBot2"/> class.
        /// </summary>
        ...
        public Bot(BotServices botServices, ConversationState conversationState, UserState userState, IBotTelemetryClient telemetryClient)
        {
            ...
            _dialogs = new DialogSet(_conversationState.CreateProperty<DialogState>(nameof(EnterpriseBot2)));
